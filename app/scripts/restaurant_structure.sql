...
CREATE TABLE `special_offers` (
  ...
  PRIMARY KEY (`id`),
  KEY `menu_item_id` (`menu_item_id`),
  CONSTRAINT `special_offers_ibfk_1` FOREIGN KEY (`menu_item_id`) REFERENCES `menu_items` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `users` (
  ...
  `role` enum('staff','customer') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'customer',
...
-- Dump completed on 2025-02-05 14:52:16
